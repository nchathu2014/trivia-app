# Trivia - Full Stack API Final Project
...
DB requirment: Postgress 13.x required with the default port 5432
...
[T.D. Nuwan Chaturanga](https://www.linkedin.com/in/nchathu/) authored the API (`app.py`), test suite (`test_app.py`), and this README.
